...
@Component({
  selector: 'app-file-folder-edit',
  templateUrl: './file-folder-edit.component.html',
  styleUrls: ['./file-folder-edit.component.css']
})
export class FileFolderEditComponent implements OnInit {
  chartShow = false;
  users = [
